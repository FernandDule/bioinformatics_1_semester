#!/bin/bash
#SBATCH --job-name=spades_improved
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=08:00:00
#SBATCH --output=/home/STUDY/FBMF/studfbmf02_10/hw4/spades_improved_%j.log
...
# Улучшенная сборка SPAdes с автоподбором k-мера
echo "Запуск улучшенного SPAdes"
mkdir -p ${OUTDIR}/spades_improved
$SPADES \
    -1 $R1 \
    -2 $R2 \
    -o ${OUTDIR}/spades_improved \
